...
router.get('/SoldInShop', OrderController.getOrdersSoldInShop);
...
router.post('/sellEmployee', OrderController.SellInShop);
router.get('/user/:mobileNumber', OrderController.getOrderByMobileNumber);
router.patch('/:id/admin', validateObjectId, OrderController.ChangeOrderStatus);
